    ...
    <>
      <div className="container mx-auto  ">
        ...
        <div className="flex justify-between">
          <Link href="/auth/sing_up/choose_account" className="px-6 py-3 bg-gray-300 text-gray-800 font-semibold rounded-lg hover:bg-gray-400 transition duration-300">           
              Back           
          </Link>
          <button
            className={`px-6 py-3 bg-primary text-white font-semibold rounded-lg transition duration-300 ${
              isChecked ? 'hover:bg-primary_hover' : 'opacity-50 cursor-not-allowed'
            }`}
