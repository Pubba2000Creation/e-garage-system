...
export default function FillInformation() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log(firstName,lastName,vehicalType,companyName,selectedDate,phoneNumber);
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <Card className="m-auto w-full max-w-md rounded-2xl overflow-hidden shadow-xl border-gray">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center">Now fill out your information.</CardTitle>
