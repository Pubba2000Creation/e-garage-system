        ...
        <div className="md:col-span-2">
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div className="flex items-center gap-1 mb-0">
              <div>
                <h2 className="text-2xl font-bold text-center">{props.shopName}</h2>
        ...
        <div className="md:col-span-1">
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <ul className='text-gray'>
              <li className='flex gap-2 my-2'><span className='py-1'><CiLocationOn /></span> Address: {props.address}</li>
              <li className='flex gap-2 my-2'><span className='py-1'><CiPhone /></span> Phone: {props.phoneNumber}</li>
              <li className='flex gap-2 my-2'><span className='py-1 text-whatapp'><IoLogoWhatsapp /></span> WhatsApp: {props.whatsappNumber}</li>
            </ul>
