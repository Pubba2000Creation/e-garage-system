...
export default function HeroSectionComponent() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if ( services || selectedDistrict) { // serach not matched
      setSerach(true);
      return;
    }
    if (false){  // serach not matched
  ...
  return (
    <>
        <section id="hero-section" className="relative h-[600px] w-full overflow-hidden mt-3">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center ">
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-3xl flex flex-col sm:flex-row gap-4">
              <div className="flex-grow flex rounded-md overflow-hidden gap-x-2 bg-white">
                ...
                <div className="w-1/2 flex items-center justify-center">
                    <SelectDistrictHeroSectionCombobox value={selectedDistrict} onChange={setSelectedDistrict}/>
                </div>            
