...
export default function UserSearchPopSection(
    props:{
        search_count:number ;
        ...
        <div className="flex w-full my-1 ">
          ...
          <main className="w-full lg:w-3/4 p-4 bg-white rounded-md shadow-md">
            ...
            <div className="space-y-4">
              ...
              {props.searchingError === true ? <SearchErrorTag search_key_word={props.search_key_word}/> 
              : 
               <>
                ...
                <form  className="flex justify-center gap-0.5">
                    <SmBtn type="button" fun={() => {handleButtonClick("Previous")}}  name={"Previous"}/>
                    <SmBtn type="button" fun={() => {handleButtonClick("1")}} name={"1"}/>
                    <SmBtn type="button" fun={() => {handleButtonClick("2")}} name={"2"}/>
                    <SmBtn type="button" fun={() => {handleButtonClick("3")}} name={"3"}/>
                    <SmBtn type="button" fun={() => {handleButtonClick("...")}} name={"..."}/>
                    <SmBtn type="button" fun={() => {handleButtonClick("Next")}} name={"Next"}/>                                                                
                </form> 
