    ...
    <section id="category_section" className="my-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <CategoryCards
          title="Repair Shops"
          img={repair_Shops}
          fun={() => handleClickCategory('Repair Shops')}
        />
        <CategoryCards
          title="Spare Parts"
          img={Spare_Parts}
          fun={() => handleClickCategory('Spare Parts')}
        />
        <CategoryCards
          title="Oil Changes"
          img={Oil_Changes}
          fun={() => handleClickCategory('Oil Changes')}
        />
        <CategoryCards
          title="Vehicle Inspections"
          img={Vehicle_Inspections}
          fun={() => handleClickCategory('Vehicle Inspections')}
        />
        <CategoryCards
          title="Tire Services"
          img={Tire_Services}
          fun={() => handleClickCategory('Tire Services')}
        />
        <CategoryCards
          title="Service Centers"
          img={Service_Centers}
          fun={() => handleClickCategory('Service Center')}
        />
      </div>
    </section>
  )
