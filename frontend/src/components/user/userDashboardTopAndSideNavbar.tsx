  ...
  return (
    <>
      ...
      <div className="flex h-screen relative">
        ...
        >
          <div className="p-6">
            <nav className="space-y-6">
              ...
              <Link href="/user/home" className="flex items-center space-x-3 pt-5">
        ...
        {/* Main Content */}
        <div
          className={`flex-1 p-8 transition-transform duration-300 ${isOpen ? 'translate-x-64 md:translate-x-0' : 'ml-0'
          }`}
        >
